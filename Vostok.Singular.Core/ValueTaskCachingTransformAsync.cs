...
{
    internal class ValueTaskCachingTransformAsync<TRaw, TProcessed>
    {
        private readonly Func<ValueTask<TRaw>> provider;
        ...
        public ValueTaskCachingTransformAsync(
            Func<TRaw, TProcessed> processor,
            Func<ValueTask<TRaw>> provider = null,
        ...
        public async ValueTask<TProcessed> GetAsync()
        {
            if (provider == null)
        ...
        private async ValueTask<TProcessed> GetAsync(TRaw raw)
        {
